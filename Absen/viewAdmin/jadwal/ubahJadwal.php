...
?>
        ...
        <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" for="" name="semester" class="form-control" value="<?= $row['semester']; ?>" required>
              </div>

              <div class="mb-3">
                <label for="" class="form-label">Tahun Ajaran</label>
                <input type="text" for="" name="tahun_ajaran" class="form-control" value="<?= $row['tahun_ajaran']; ?>" required>
              </div>
