           ...
           $insert_sql = "INSERT INTO auth (username, password, role) VALUES (?, ?, ?)";
              ...
              $stmt->bind_param("sss", $username, $hashedPassword, $role);
                ...
                if ($stmt->execute()) {
                    ...
                    Registrasi Berhasil ! Silakan login disini!.
                    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                    </div>";
                    $conn->close();
...
<head>
    ...
    <style>
        body {
            background-image : url(../IMG/Furina.jpg);
        ...
        <div class="col-md-7 p-5">
            ...
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <div class="mb-4">
                        <label for="password" class="form-label">Password</label>
                        <input type="text" class="form-control" id="password" name="confirmPassword" required>
                    </div>
                    <button type="submit" class="btn btn-primary w-100" name="submit" value="submit">Daftar</button>
